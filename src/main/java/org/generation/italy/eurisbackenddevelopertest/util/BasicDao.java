...
public abstract class BasicDao {
     ...
     * @throws SQLException
     */
    private PreparedStatement preparedStatementWithGeneretedKey ( String sql , Object... conditions ) throws SQLException {
    ...
    public int insertAndGetId ( String sql , Object... conditions ) {
        int id = 0;
        try {
            PreparedStatement stm = preparedStatementWithGeneretedKey ( sql , conditions );
            stm.executeUpdate ( );
